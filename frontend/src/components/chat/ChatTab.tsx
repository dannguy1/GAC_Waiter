...
import { Send, User, Bot, Sparkles, Volume2, VolumeX, Loader2 } from "lucide-react";
            ...
            <form onSubmit={handleSend} className="p-4 border-t bg-white">
                <div className="relative">
                    <input
                        ...
                        className="w-full pl-4 pr-12 py-3 bg-slate-100 border-transparent focus:bg-white focus:border-primary focus:ring-1 focus:ring-primary rounded-full outline-none transition-all"
